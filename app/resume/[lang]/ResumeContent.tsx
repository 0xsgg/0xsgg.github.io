    ...
    return (
        <div className="max-w-6xl mx-auto px-8 py-10 print:py-0">
            ...
            {/* <div className="flex justify-end gap-3 mb-6 no-print">
                <Link
                    href="/resume/zh"
                    className={`text-sm ${!isEnglish ? 'font-bold text-text-primary' : 'text-text-primary opacity-60 hover:opacity-100'} transition-opacity`}
                >
                    中文
                </Link>
                ...
                <div className="md:col-span-6">
                                ...
                                <div key={index}>
                                    <div className="grid grid-cols-[80px_1fr] gap-5 items-baseline text-md text-text-primary mb-2">
                                        ...
                                        <p className="leading-relaxed tracking-wide">
                                            {
                                                skill.keywords.map((name: string, index: number) => {
                                                    return (
                    ...
                    <section className="grid items-center justify-center">
                        <div className="text-center no-print text-sm mt-2 mb-2">
                            <Link href={`/resume-${lang}.pdf`} className="text-text-primary opacity-80 hover:opacity-100 underline underline-offset-4 decoration-dashed decoration-1 transition-opacity" isExternal>
                                PDF Version
                            </Link>
                        </div>
