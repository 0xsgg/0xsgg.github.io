            ...
            <div className="grid grid-cols-1 md:grid-cols-10">
                ...
                <div className="md:col-span-6">
                    ...
                    <section className="mb-8 md:mb-12">
                        ...
                        <div className="md:pl-4 text-text-primary opacity-90 leading-relaxed space-y-4">
                    ...
                    <div className="grid grid-cols-1 print:grid print:grid-cols-5 mb-8 md:mb-12">
                        {/* 开源项目 */}
                        <section className="print:col-span-2 mb-8 md:mb-12">
                            <h2 className="text-md mb-4 tracking-wide">
                                <span className="bg-black text-white px-1">Projects</span>
                            </h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:pl-4">
                        ...
                        {/* 工作经历 */}
                        <section className="print:col-span-3 print:pl-3">
                            <h2 className="text-md mb-4 tracking-wide">
                                ...
                                {work.map((job, index) => (
                                    <div key={index} className="text-text-primary text-sm">
                                        <div className="flex flex-col mb-2">
                                            <h3 className="all-unset flex flex-wrap items-center gap-3 text-md font-semibold mb-1">
                                                <Link href={job.website} isExternal className="text-md text-text-primary hover:opacity-100 hover:text-black underline underline-offset-4 decoration-dashed decoration-1">{job.company}</Link>
